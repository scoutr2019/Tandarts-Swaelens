...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile menu overlay */}
      <div 
        className={`lg:hidden fixed inset-0 bg-black/70 backdrop-blur-sm transition-opacity duration-300 z-[51] ${
      ...
      {/* Mobile menu */}
      <div 
        className={`lg:hidden fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 shadow-2xl transition-transform duration-300 transform z-[52] ${
